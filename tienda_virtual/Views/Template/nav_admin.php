    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-lock" aria-hidden="true"></i><span class="app-menu__label">Recursos Humanos</span><i class="treeview-indicator fa fa-angle-right"></i></a>
